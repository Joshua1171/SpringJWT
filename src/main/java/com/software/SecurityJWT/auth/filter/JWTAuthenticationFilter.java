package com.software.SecurityJWT.auth.filter;

import com.fasterxml.jackson.core.JsonParseException;
import com.fasterxml.jackson.databind.JsonMappingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.software.SecurityJWT.auth.service.JWTService;
import com.software.SecurityJWT.auth.service.JWTServiceImpl;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (username !=null && password!=null){
            ...
            logger.info("Username from request parameter (form-data): "+password);
        }else{
